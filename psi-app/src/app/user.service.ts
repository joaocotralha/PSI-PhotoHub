...
@Injectable({
  ...
  export class UserService {
    ...
    private userUrl = "http://appserver.alunos.di.fc.ul.pt:3080";
    // private registerUrl = "http://localhost:3080/register";
    private registerUrl = "http://appserver.alunos.di.fc.ul.pt:3080/register";
    // private loginUrl = "http://localhost:3080/login";
    private loginUrl = "http://appserver.alunos.di.fc.ul.pt:3080/login";
    // private homeUrl = "http://localhost:3080/home";
    private homeUrl = "http://appserver.alunos.di.fc.ul.pt:3080/home";
    // private favoritesUrl = "http://localhost:3080/favorites"; 
    private favoritesUrl = "http://appserver.alunos.di.fc.ul.pt:3080/favorites";
